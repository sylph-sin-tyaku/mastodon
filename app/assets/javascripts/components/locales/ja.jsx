const ja = {
  ...
  "notification.favourite": "{name} さんが+1しました",
  "notification.follow": "{name} さんにフォローされました",
  "notification.mention": "{name} さんが返信しました",
  "notification.reblog": "{name} さんがブーストしました",
  "notifications.clear": "通知を消去",
  "notifications.clear_confirmation": "本当に通知を消去しますか？",
  "notifications.column_settings.alert": "デスクトップ通知",
  "notifications.column_settings.favourite": "+1",

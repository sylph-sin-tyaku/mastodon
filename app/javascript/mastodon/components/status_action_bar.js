  ...
  render () {
    ...
    return (
      <div className='status__action-bar'>
        ...
        <IconButton className='status__action-bar-button star-icon' animate active={status.get('favourited')} title={intl.formatMessage(messages.favourite)} icon='' text='+1' onClick={this.handleFavouriteClick} />
